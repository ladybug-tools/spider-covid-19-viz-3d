...
function xxdisplayStats ( totalsGlobal, totalsChina, totalsEurope, totalsUsa, totalsRow ) {
...
function getNotes () {
	...
	divSettings.innerHTML = `<details id=detSettings ontoggle=getNotesContent() >
		...
		<p>
			<button onclick="SCC.init()" >start screen capture</button>
		</p>
		</div>
