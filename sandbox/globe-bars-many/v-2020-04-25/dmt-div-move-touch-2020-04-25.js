...
DMT.displayYourMessage = function ( intersected ) {
	...
	city = cities[ intersected.userData.index ]
	...
	<div id="DMTdivIntersected" >
		City: <a href="https://en.wikipedia.org/w/index.php?search=${ city[ 0 ] }" target="_blank">${ city[ 0 ] }</a><br>
		Country: ${ city[ 4 ] }<br>
		Admin name: ${ city[ 7 ] }<br>
		Population: ${ ( + city[ 9 ] || "NA" ).toLocaleString() }<br>
		Latitude: ${ city[ 2 ] }<br>
		Longitude: ${ city[ 3 ] }<br>
